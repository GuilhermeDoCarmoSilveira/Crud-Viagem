...
select CAST(codigo as varchar(15)) as ID, nome as Nome
from Motorista
union
...
as
select v.codigo, SUBSTRING(o.placa, 1, 3) + '-' + SUBSTRING(o.placa, 4, 4) as Placa, 
	   CONVERT(char(5), DATEADD(SECOND, v.hora_saida * 3600, 0), 108) AS Hora_Saida,
	   CONVERT(char(5), DATEADD(SECOND, v.hora_chegada * 3600, 0), 108) AS Hora_Chegada,
	   v.partida, v.destino
